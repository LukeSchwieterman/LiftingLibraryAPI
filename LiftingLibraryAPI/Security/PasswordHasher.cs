...
namespace LiftingLibrary.Security
{
    ...
    public class PasswordHasher : IPasswordHasher
    {
        ...
        public PasswordHash ComputeHash(string plainTextPassword)
        {
            ...
            Rfc2898DeriveBytes rfc = new Rfc2898DeriveBytes(plainTextPassword, 8, WorkFactor, HashAlgorithmName.SHA256);
        ...
        public bool VerifyHashMatch(string existingHashedPassword, string plainTextPassword, string salt)
        {
            ...
            //Create the hashing provider
            Rfc2898DeriveBytes rfc = new Rfc2898DeriveBytes(plainTextPassword, saltArray, WorkFactor, HashAlgorithmName.SHA256);
